        ...
        <div class="col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-2">
            <div class="panel panel-primary panel-border top">
                ...
                <div class="panel-body">
                    <div class="form-group mb-sm mt-md">
                        ...
                        <div class="row cuar-clearfix">
                            <div class="col-xs-12">
                                ...
                                <input class="form-control" type="text" name="user_login" id="user_login" value="<?php echo esc_attr($current_username); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row cuar-clearfix">
                            <div class="col-xs-12">
                                ...
                                <span class="help-block">
                                    <i class="fa fa-lightbulb-o"></i>&nbsp;&nbsp;<?php _e("A password will be e-mailed to you at this address.", 'cuarlf'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php do_action('cuar/authentication/print-register-form'); ?>
                ...
                <div class="panel-footer">
                    <input type="submit" name="cuar_do_register" value="<?php _e("Register", 'cuarlf'); ?>" class="btn btn-primary"/>
                </div>
            </div>
        </div>
    </div>
