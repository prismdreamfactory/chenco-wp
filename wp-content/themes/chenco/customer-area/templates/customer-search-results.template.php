...
<div class="table__scroll">
  <table class="investor__files" summary="Investments">
    ...
    <tbody>
      <?php foreach ($search_result as $type => $posts) :
...
<?php /* <div class="cuar-title mb30"><?php _e('Search result', 'cuarse'); ?>
</div>
...
<div class="cuar-search-result">
  ...
  <div class="search-divider" id="search-section-<?php echo $type; ?>">
    <span class="search-divider-content"><?php echo $this->get_post_type_label($type) ?> <span
        class="badge badge-primary"><?php echo count($posts); ?></span></span>
  </div>
