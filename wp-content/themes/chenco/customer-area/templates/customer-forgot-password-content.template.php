  ...
  <div class="col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-2">
    <div class="panel panel-primary panel-border top">
      <div class="panel-heading">
        <span class="panel-title fs-lg"><?php _e('Lost password?', 'cuarlf'); ?></span>
      </div>
      ...
      <div class="panel-body">
          ...
          <div class="row cuar-clearfix">
            <div class="col-xs-12">
              <div class="input-group">
                <input type="text" name="user_login" id="user_login" placeholder="<?php esc_attr_e(
                                                                                      'Username or Email',
                                                                                      'cuarlf'
                                                                                    ); ?>"
                  value="<?php echo esc_attr($current_username); ?>" class="form-control" />
              </div>
            </div>
          </div>
        </div>
        ...
        <?php if (class_exists("ReallySimpleCaptcha")) : ?><?php
                                                              ...
                                                              $prefix = mt_rand();
                                                              $captcha_src = untrailingslashit(content_url()) . '/plugins/really-simple-captcha/tmp/' . $captcha_instance->generate_image(
                                                                $prefix,
                                                                $word
                                                              );
                                                              ?>
            ...
            <div class="col-sm-12">
              ...
              <input type="text" name="captcha" id="captcha" required="required" class="form-control"
                placeholder="<?php esc_attr_e(
                                                                                                                        "Copy the code shown above in this field.",
                                                                                                                        'cuarlf'
                                                                                                                      ); ?>" />
      ...
      <div class="panel-footer">
        <input type="submit" name="cuar_do_register" value="<?php _e("Get New Password", 'cuarlf'); ?>"
